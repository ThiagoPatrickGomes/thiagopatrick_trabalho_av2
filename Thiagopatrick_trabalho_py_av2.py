...
def submit_data():
    if nome.get() == "" or email.get() == "" or endereco.get() == "":
        ...
        conn = sqlite3.connect("C:/Users/Thiag_000/Desktop/Trabalho python av2/faucldade.db")
        cursor = conn.cursor()
...
def update_data():
    tree.delete(*tree.get_children())
    conn = sqlite3.connect(" C:/Users/Thiag_000/Desktop/Trabalho python av2/faculdade.db")
    cursor = conn.cursor()
